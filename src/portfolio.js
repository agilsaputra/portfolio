...
const about = {
  ...
  role: '',
  description:
    'Currently working as Ebay Admin In addition to my eBay Admin duties, I also manage web maintenance tasks for href=https://pa6autoparts.com . This includes regular website updates, such as product additions, pricing updates, and content modifications, to ensure the site remains current and user-friendly. I also conduct routine checks for website functionality, including monitoring for broken links, resolving technical issues, and optimizing site speed and performance.',
